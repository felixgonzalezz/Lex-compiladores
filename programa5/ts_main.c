...
int main(){
    ...
    printf("Creando tablas de simbolos\n");
    SYMTAB *stable = init_sym_tab();
    append_sym(stable, simbolo1);
    append_sym(stable, simbolo2);

    SYMTAB *stable1 = init_sym_tab();
    append_sym(stable1, simbolo1);
    append_sym(stable1, simbolo2);

    SYMTAB *stable2 = init_sym_tab();
    append_sym(stable2, simbolo1);
    append_sym(stable2, simbolo2);
    ...
    push_st(spila,stable1);
    push_st(spila,stable2);
